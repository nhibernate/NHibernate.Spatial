    ...
    internal static class DataGenerator
    {
        ...
        private class LineStringCreator : IGeometryCreator
        {
            public Geometry Create()
            {
                ...
                var coordinates = new Coordinate[numCoords];
        ...
        private class MultiLineStringCreator : IGeometryCreator
        {
            public Geometry Create()
            {
                ...
                var lsc = new LineStringCreator();
                var lines = new LineString[numGeoms];
        ...
        private class LinearRingCreator : IGeometryCreator
        {
            public Geometry Create()
            {
                ...
                var coordinates = new Coordinate[numCoords + 1];
                ...
                var lr = GeometryFactory.Default.CreateLinearRing(coordinates);
                return lr;
            }
        }
        ...
        private class PolygonCreator : IGeometryCreator
        {
            public Geometry Create()
            {
                var lr = (LinearRing) new LinearRingCreator().Create();
                var pg = GeometryFactory.Default.CreatePolygon(lr, null);
                return pg;
            }
        }
